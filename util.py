...
def load_data():
    ...
    # The training set
    for i in range(6):
        with open(f"/home/lilvmy/python_demo/Alphbet_MNIST_Dataset/data/character_dataset_train{i}.pkl", "rb") as input_file:
    ...
    # The testing set
    with open(f"/home/lilvmy/python_demo/Alphbet_MNIST_Dataset/data/character_dataset_test.pkl", "rb") as input_file:
